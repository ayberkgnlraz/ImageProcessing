...
for line in lines:
    ...
    # Checking if the current line is close to any previously detected line
    skip_line = False
    for stored_line in all_lines:
        ...
        # Skiping the line if it is close to another line and has a similar angle
